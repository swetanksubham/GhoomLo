...
public class TrainBooking extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toast.makeText(this, "Trains are running late due to smog! Please check the status before booking!", Toast.LENGTH_LONG).show();
    }
    boolean checkfn(){
    ...
    public void addDatepicker(View view)
    {
        ...
        // date picker dialog
        datePickerDialog[0] = new DatePickerDialog(TrainBooking.this,
            ...
            alertDialogBuilder.setPositiveButton("Okay!",
                    new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface arg0, int arg1) {
                            Toast.makeText(TrainBooking.this, "Thanks for choosing us!", Toast.LENGTH_LONG).show();
                            finish();
                        }
                    });
