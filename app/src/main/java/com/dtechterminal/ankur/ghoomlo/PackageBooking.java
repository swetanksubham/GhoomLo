...
public class PackageBooking extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.package_booking);
    ...
    public void addDatepicker(View view)
    {
        ...
        // date picker dialog
        datePickerDialog[0] = new DatePickerDialog(this,
            ...
            alertDialogBuilder.setPositiveButton("Okay!",
                    new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface arg0, int arg1) {
                            Toast.makeText(PackageBooking.this, "Thanks for choosing us!", Toast.LENGTH_LONG).show();
                            finish();
                        }
                    });
